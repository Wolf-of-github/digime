...
const educationData = [
  {
    ...
    description: 'Focusing upon LLM and cloud deployment for large-scale software applications',
    coursework: ['Distributed Systems', 'Artificial Intelligence', 'Deep Learning', 'Cryptography', 'Databases', 'Information retrieval'],
    level: 'Graduate',
    status: 'In Progress'
  },
  {
