        ...
        <div className="space-y-12">
          {experiences.map((exp, index) => (
            <div key={index} className="relative">
              {/* Timeline dot */}
              <div className="hidden md:block absolute left-6 w-5 h-5 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full border-4 border-gray-900"></div>
              
              {/* Experience Card */}
              <div className="md:ml-20 bg-white bg-opacity-10 text-white rounded-xl p-8 shadow-lg hover:shadow-2xl transition duration-300">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="mb-6">
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4">
                        <div className="flex items-center gap-3">
                          ...
                          <span className="text-lg text-gray-300 font-mono truncate">
                            {exp.company}
                          </span>
                        </div>
                      ...
                      {/* Period Badge */}
                      <div className="inline-flex items-center gap-2 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-400/30 text-blue-200 px-4 py-2 rounded-full text-sm font-mono font-medium">
                  ...
                  <div className="lg:col-span-1 flex justify-center lg:justify-end">
                    <a
                      ...
                      className="group relative flex items-center justify-center bg-gradient-to-r from-blue-500/20 to-purple-500/20 hover:from-blue-500/30 hover:to-purple-500/30 text-white hover:text-gray-200 p-4 rounded-xl transition-all duration-300 border border-blue-400/30 hover:border-blue-400/50 hover:scale-105"
                      title="View Letter of Recommendation"
                    >
                      <ExternalLink className="w-6 h-6 transition-transform duration-200" />
                      <div className="absolute -top-2 -right-2 w-3 h-3 bg-gradient-to-r from-blue-400 to-purple-500 rounded-full animate-ping opacity-75"></div>
